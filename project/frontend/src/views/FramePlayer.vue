<template>
        ...
        <el-container>
          ...
          <el-aside width="500px" style="background-color: rgb(238, 241, 246); overflow-x: hidden">
         
            <div class="tools">
            <el-row>
              <el-icon style="font-size: 32px;"><Camera /></el-icon>
            </el-row>
            <label>
            <span>FPS：</span>
    ...
    function loadImages (Parameter) {
      ...
      var imgArr = [];
        ...
        for (var i = 0; i < 90; i++) {
          imgArr.push("https://curtain-wall.oss-cn-shanghai.aliyuncs.com/low-res/" + i + ".jpg");
        }
